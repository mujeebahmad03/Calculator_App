...
class Calculator:
    ...
    def __init__(self, root):
        ...
        self.style.configure('Numeric.TButton', background='#D3D3D3')
        self.style.configure('Operator.TButton', background='#FFA500')
        self.style.configure('Memory.TButton', background='#4ADEDE')
        self.create_buttons()
    ...
    def handle_button_click(self, text):
        ...
        if text.isdigit() or text in '+-/.*()':
            ...
            if text == '=':
                ...
                self.perform_unary_operation(cbrt, 'unary')
            elif text == '^2':
